...
| [`update-deps`](skills/update-deps/SKILL.md)                           | Updates a repo's dependencies to their newest allowed versions — minor by default — across Node and PHP, driving the repo's own updater instead of bypassing its gates, pins and constraints. |
