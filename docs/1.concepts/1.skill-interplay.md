...
description: 'How the eighteen skills reach each other, and which of them an agent may fire on its own.'
---
...
Only nine of the eighteen ever invoke another skill, and they form two independent shapes. Throughout, **solid** is real delegation — one skill hands over a step and lets the other own it — and **dashed** is a handover through the tracker, where neither side calls the other.
