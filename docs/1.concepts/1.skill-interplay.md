...
Only nine of the sixteen ever invoke another skill, and they form two independent shapes. Throughout, **solid** is real delegation — one skill hands over a step and lets the other own it — and **dashed** is a handover through the tracker, where neither side calls the other.
