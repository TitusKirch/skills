...
On the **local** tracker ([ADR-0023](/adr/0023-back-the-local-tracker-with-committed-files)) there is no label at all: the same eight states are written into an issue file's `state` frontmatter field, by their **config key**. That is the clearest demonstration of the sentence above — the key is the lifecycle, and the string is one tracker's way of showing it.
...
| For                                                                   | Read                                                                                                                                                                                                                              |
| :-------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The state machine, transitions, leasing, reconcile, selection queries | [`work-implement/REFERENCE.md`](https://github.com/TitusKirch/skills/blob/main/skills/work/work-implement/REFERENCE.md)                                                                                                           |
| Verdicts, the round cap, the escalation policy, feedback channels     | [`work-review/REFERENCE.md`](https://github.com/TitusKirch/skills/blob/main/skills/work/work-review/REFERENCE.md)                                                                                                                 |
| Why the loops are split, and the decisions behind the label set       | [`work-implement/DESIGN.md`](https://github.com/TitusKirch/skills/blob/main/skills/work/work-implement/DESIGN.md)                                                                                                                 |
| Draining, ordering, caps and locks                                    | [`work-implement-queue`](https://github.com/TitusKirch/skills/blob/main/skills/work/work-implement-queue/SKILL.md) · [`work-review-queue`](https://github.com/TitusKirch/skills/blob/main/skills/work/work-review-queue/SKILL.md) |

How these four sit among the other eighteen skills: [skill interplay](/concepts/skill-interplay).
