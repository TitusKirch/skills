...
| [ADR-0014](0014-let-rationale-travel-with-the-skill.md)                       | Let rationale travel with the skill                         | superseded | 2026-08-26 |
...
| [ADR-0031](0031-keep-rationale-as-repo-memory.md)                             | Keep rationale as repo memory                               | accepted   | 2026-08-26 |
| [ADR-0032](0032-select-a-dependency-request-by-its-author-alone.md)           | Select a dependency request by its author alone             | accepted   | 2026-08-26 |
| [ADR-0033](0033-classify-a-stale-branch-by-why-it-is-stale.md)                | Classify a stale branch by why it is stale                  | accepted   | 2026-08-26 |
| [ADR-0034](0034-judge-a-comment-against-the-code-beneath-it.md)               | Judge a comment against the code beneath it                 | accepted   | 2026-08-26 |
| [ADR-0035](0035-bind-the-release-skill-to-its-release-tool.md)                | Bind the release skill to its release tool, not its forge   | accepted   | 2026-08-26 |
| [ADR-0036](0036-bound-update-deps-by-the-repos-own-tooling.md)                | Bound update-deps by the repo's own tooling                 | accepted   | 2026-08-26 |
| [ADR-0037](0037-commit-a-handoff-into-the-repo-it-hands-off.md)               | Commit a handoff into the repo it hands off                 | accepted   | 2026-08-26 |
| [ADR-0038](0038-fix-the-tldr-frame-and-invoke-it-on-request.md)               | Fix the tldr frame and invoke it on request                 | accepted   | 2026-08-26 |
