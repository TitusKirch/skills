...
Config/cache schema, the guided setup flow, the tracker-neutral issue-template rules, GitHub and Linear tracker recipes, sub-issue mechanics, the plan-output format, and worked examples: [REFERENCE.md](REFERENCE.md).
